...
[![Test](https://github.com/Kush-Wednesday/pdfcpu-custom/workflows/Test/badge.svg)](https://github.com/Kush-Wednesday/pdfcpu-custom/actions)
...
[![GoDoc](https://godoc.org/github.com/Kush-Wednesday/pdfcpu-custom?status.svg)](https://pkg.go.dev/github.com/Kush-Wednesday/pdfcpu-custom)
[![Go Report Card](https://goreportcard.com/badge/github.com/Kush-Wednesday/pdfcpu-custom)](https://goreportcard.com/report/github.com/Kush-Wednesday/pdfcpu-custom)
[![Hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://opensource.org/licenses/Apache-2.0)
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/Kush-Wednesday/pdfcpu-custom/releases)
...
- For API examples of all pdfcpu operations please refer to [GoDoc](https://pkg.go.dev/github.com/Kush-Wednesday/pdfcpu-custom/pkg/api).

### GoDoc

- [pdfcpu package](https://pkg.go.dev/github.com/Kush-Wednesday/pdfcpu-custom)
- [pdfcpu API](https://pkg.go.dev/github.com/Kush-Wednesday/pdfcpu-custom/pkg/api)
- [pdfcpu CLI](https://pkg.go.dev/github.com/Kush-Wednesday/pdfcpu-custom/pkg/cli)
...
Get the latest binary [here](https://github.com/Kush-Wednesday/pdfcpu-custom/releases).

### Using Go Modules

```
git clone https://github.com/Kush-Wednesday/pdfcpu-custom
